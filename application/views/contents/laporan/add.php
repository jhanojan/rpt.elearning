       ...
       <form id="form" method="post" enctype="multipart/form-data" action="<?php echo base_url($this->utama)?>/submit" class="form-horizontal formular" role="form">
		   ...
		   <div class="form-group">
			   ...
			   <div class="col-sm-3">
				   <label for="<?php echo $nm_f?>">File Lampiran</label>
                                        ...
                                        <input type="file" name="filez[]" multiple="">
                                        <?php 
                                                echo "*) Mohon berikan nama file dengan nomor SISDA";
		   ...
		   <div class="form-group">
			   ...
			   <div class="col-sm-3">
				   ...
				   <?php echo form_dropdown($nm_f,$opt_periode,(isset($val['periode']) ? $val['periode'] : ''),"class='col-md-9 col-sm-12' id='$nm_f' required ");
         ?>
			   </div>
		   </div>
                   </div>
