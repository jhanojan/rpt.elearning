       ...
       <form id="form" method="post" enctype="multipart/form-data" action="<?php echo base_url($this->utama)?>/upload_mpr_submit" class="form-horizontal formular" role="form">
         ...
         ?>
		   ...
		   <div class="form-group">
			   ...
			   <div class="col-sm-12">
                               <a href="<?php echo base_url()?>assets/template/mpr/tk_new.xlsx" class="btn btn-primary">Download Template Rekap TK</a>&nbsp;
                               <a href="<?php echo base_url()?>assets/template/mpr/sd_new.xlsx" class="btn btn-primary">Download Template Rekap SD</a>&nbsp;
                               <a href="<?php echo base_url()?>assets/template/mpr/smp_new.xlsx" class="btn btn-primary">Download Template Rekap SMP</a>&nbsp;
			   </div>
