...
<div class="item">
	...
	Status Tagihan :
        ...
        Belum Tersedia
        <?php }else{?>
        <?php echo Rupiah($tagihan['total_non_diskon']) . ' - '. $tagihan['status_bayar']." - <a href='".base_url()."keuangan/cetak_tagihan/".$tagihan['id']."'>Detail</a>"?>
        <?php }?>
	 <hr>
  ...
  <div class="box">
    <div class="box-header">
      <h2>Laporan Nilai</h2>
         ...
         <div class="box">
    <a href="<?php echo base_url()?>dashboard/pdf/<?php echo webmasterkid()?>/true" class="btn btn-info pull-right">Export PDF</a>
         </div>
         <div class="box">
             <div class="col-md-12">
         <?php
