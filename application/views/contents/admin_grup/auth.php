		...
		<div class="col-md-12">
			<div class="invoice">
				...
				<div class="form-group">
					<div class="col-md-12" style="margin-top:20px;border-top:1px solid #8CE5FF;">	
						<div class="col-md-6">
							...
							<?php echo form_input('user_group',GetValue('title','admin_grup',array('id'=>'where/'.$id_user)),"readonly='readonly' style='background:none;'");?>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
						...
						$getv=GetValue('view','users_permission_sf',array('menu_id'=>'where/'.$mod['id'],'user_group'=>'where/'.$id_user));
						$getc=GetValue('create','users_permission_sf',array('menu_id'=>'where/'.$mod['id'],'user_group'=>'where/'.$id_user));
						$getu=GetValue('update','users_permission_sf',array('menu_id'=>'where/'.$mod['id'],'user_group'=>'where/'.$id_user));
						$getd=GetValue('delete','users_permission_sf',array('menu_id'=>'where/'.$mod['id'],'user_group'=>'where/'.$id_user));
						...
						?>
							...
							<?php foreach($submodul->result_array() as $sm){ 
								...
								$getv=GetValue('view','users_permission_sf',array('menu_id'=>'where/'.$sm['id'],'user_group'=>'where/'.$id_user));
								$getc=GetValue('create','users_permission_sf',array('menu_id'=>'where/'.$sm['id'],'user_group'=>'where/'.$id_user));
								$getu=GetValue('update','users_permission_sf',array('menu_id'=>'where/'.$sm['id'],'user_group'=>'where/'.$id_user));
								$getd=GetValue('delete','users_permission_sf',array('menu_id'=>'where/'.$sm['id'],'user_group'=>'where/'.$id_user));
							?>
