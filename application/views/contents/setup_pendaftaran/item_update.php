<?php
$opt_item['']='-Item-';
$lengkap=$this->db->query("SELECT * FROM sv_setup_pendaftaran WHERE id='".$id_data."'")->row_array();
//lastq();
$q="SELECT * FROM sv_setup_itempay WHERE ta='".$lengkap['ta']."' AND (jenjang='all' OR jenjang='".$lengkap['jenjang']."')";
