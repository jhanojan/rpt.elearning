...
<div class="row">
    <div class="col-md-12">
        <div class="col-md-6">
            <div class="col-md-3" style="font-size:10pt">Pembayaran Ke </div>
            <div class="col-md-3" style="font-size:10pt"><?php echo $datapay['termin']?></div>
        </div>
    </div>
    <div class="col-md-12">
        <div class="col-md-6">
            <div class="col-md-3" style="font-size:10pt">Pembayaran Sebelumnya</div>
            <?php 
            $tot=0;
            foreach($history->result_array() as $h){
                $tot+=$h['bayar'];
            }?>
            <div class="col-md-6" style="font-size:10pt"><?php echo uang($tot)?></div>
        </div>
    </div>
...
<a class="btn btn-info" href="<?php echo base_url()?>/payment/cetak_kwtiansi_pmb/<?php echo $datapay['id'] ?>"><i class="fa fa-print"></i> Cetak Kwitansi</a>