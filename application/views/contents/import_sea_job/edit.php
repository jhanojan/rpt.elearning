    	...
    	<div class="box-content">
			<form id="form" method="post" enctype="multipart/form-data" action="<?php echo base_url($this->utama)?>/submit" class="form-horizontal formular" role="form">
				...
				<div class="col-sm-3" style="display:none">
					...
					<?php $a="CC";
						$mark=($val[$nm_f]==$a || $_GET['type']===$a ? TRUE : FALSE);
						//echo $mark;
						$data = array(
						'name'        => $nm_f,
						'id'          => $nm_f,
				...
				<div class="form-group">
					...
					?>
					<div class="col-sm-3">
						<label for="<?php echo $nm_f?>">POL</label>
						</div><div class="col-sm-3">
					...
					<?php $nm_f="mbl";?>
					<div class="col-sm-2">
						<label for="<?php echo $nm_f?>">MBL #</label>
						</div><div class="col-sm-2">
						<input type="text" name="<?php echo $nm_f?>"  id="<?php echo $nm_f?>" value="<?php echo $a= (isset($val[$nm_f]) ? $val[$nm_f] : '') ?>" class="col-sm-12  text-input">
					</div>
					<?php $nm_f="mbl_date";?>
					...
					<?php $nm_f="hbl";?>
					<div class="col-sm-2">
						<label for="<?php echo $nm_f?>">HBL#</label>
						</div><div class="col-sm-2">
						<input type="text" name="<?php echo $nm_f?>"  id="<?php echo $nm_f?>" value="<?php echo $a= (isset($val[$nm_f]) ? $val[$nm_f] : '') ?>" class="col-sm-12  text-input">
					</div>
					<?php $nm_f="hbl_date";?>
					...
					?>
					<div class="col-sm-3">
						<label for="<?php echo $nm_f?>">POD</label>
						</div><div class="col-sm-3">
						<?php echo form_dropdown($nm_f,$opt_port,$sel,'class="chosen-select form-control" id="'.$nm_f.'" data-placeholder="Choose a State..." ')?>
					</div>
					<!--Bagian Kanan-->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php echo form_dropdown($nm_f,$opt_vsl,$sel,'class="chosen-select form-control" id="'.$nm_f.'" data-placeholder="Choose a State..." ')?>
					</div>
				...
				<div class="form-group">
					<?php $nm_f="vsl_voy";?>
					<div class="col-sm-3">
						<label for="<?php echo $nm_f?>">Voy</label>
						</div><div class="col-sm-3">
						<input type="text" name="<?php echo $nm_f?>"  id="<?php echo $nm_f?>" value="<?php echo $a= (isset($val[$nm_f]) ? $val[$nm_f] : '') ?>" class="col-sm-12  text-input">
					</div>
