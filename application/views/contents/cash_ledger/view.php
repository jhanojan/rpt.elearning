...
<br />
<form method="get" action="<?php echo base_url($this->utama)?>">
<input type='text' name="q"><button type="submit" value="GO!">Search</button>
</form>
<br /><?php if(isset($_GET['q'])){ ?>
<span>Search Results for <strong><?php echo $_GET['q']?></strong>
</span>
<?php } ?>
<?php
error_reporting(0);
