    <?php
$opt_item['']='-Item-';
$lengkap=$this->db->query("SELECT a.*,b.tingkat tingkat,c.jenjang jenjang FROM sv_kelas_siswa a left join sv_master_kelas b on a.kelas=b.id left join sv_master_tingkat c on b.tingkat=c.id  WHERE ta='".post('t')."' AND siswa_id='".post('s')."'")->row_array();
//lastq();
...
<div class="input-produk form-group" id="input-produk-<?php echo $id ?>" style="border-bottom:1px #0044cc dashed;margin-bottom:20px;">
			   ...
			   <div class="col-sm-2">
                ...
                //lastq();?>
                                ...
                                <?php echo form_input('price[]','','class="hargasatuan" style="background:white!important;border:0px;" id="item-price-'.$id.'" readonly')?>
			   </div>
		   </div>
