...
<div class="row box">
    ...
    <div class="box-header well" data-original-title="">
        <h2>Update Status Bayar</h2>

        
    </div>
    	<div class="box-content">
       <form id="form" method="post" enctype="multipart/form-data" action="<?php echo base_url($this->utama)?>/upload_update_submit" class="form-horizontal formular" role="form">
		   ...
		   <div class="form-group">
			   ...
			   <div class="col-sm-12">
                               <a href="<?php echo base_Url()?>assets/template/template_update_bayar.xlsx" class="btn btn-primary">Download Template Update Bayar</a>
			   </div>
