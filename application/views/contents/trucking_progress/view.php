<span style="font-size:24px; margin-bottom:5%; margin-top:5%;"><?php
 echo $this->title.' '.$jo;?></span>
...
function btn(com,grid)
{
	...
	if(com=='Account Information'){
		if($('.trSelected',grid).length==1){ 
			...
			//var items = $('.trSelected',grid);
			window.location = _base_url + 'ai/main/trucking/' + $('td:nth-child('+ (1+$.inArray('idnya',abbr)) +')>div', '.trSelected',grid).text();
		} else {
			return false;
		} 
	}
