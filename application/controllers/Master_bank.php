...
class Master_bank extends CI_Controller {
	...
	function listcol(){
            ...
            $colModel['title'] = array('Nama',110,TRUE,'left',2);
            $colModel['code'] = array('Kode Rekening',110,TRUE,'left',2);
			return $colModel;
	}
	...
	function form($id=null){
		...
		//$data['opt']=GetOptAll('menu','-Parents-');
                $data['opt_leader']=GetOptAll('sv_master_bank','-Leader-',array(),'nama_lengkap');
