...
class Setup_account_mapping extends CI_Controller {
	
		var $utama ='setup_account_mapping';
		var $title ='Sheet Master List';
...
error_reporting(0);
	...
	function main()
	{
		...
		$data['content'] = 'contents/'.strtolower($this->utama).'/view';
	...
	function form($id=null){
		...
		$data['opt_acmap']=GetOptAll('ref_accmap','-Type-',array(),'name');
	...
	function submit(){
		...
		{
			$data['code']=generatenumbering('amapping');
