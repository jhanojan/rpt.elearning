...
class Setup_profit_loss extends CI_Controller {
	
		var $utama ='setup_profit_loss';
		var $title ='Setup Profit Loss';
...
error_reporting(0);
	...
	function get_column(){
            ...
            $colModel['title'] = array('title',110,TRUE,'left',2);
            $colModel['transaksi'] = array('transaksi',110,TRUE,'left',2);
            $colModel['type'] = array('type',110,TRUE,'left',2);
	...
	function get_record(){
		...
		$valid_fields = array('id','coa','title','type');
