...
class Master_bill_lading extends CI_Controller {
	
		var $utama ='master_bill_lading';
		var $title ='Master Bill of Lading';
...
error_reporting(0);
	...
	function get_column(){
		...
		$colModel['dates'] = array('Dates',110,TRUE,'left',2);
	...
	function get_record(){
		...
		$valid_fields = array('id','code','name','dates');
