...
class Master_trucking extends CI_Controller {
	
		var $utama ='master_trucking';
		var $title ='Master trucking';
...
error_reporting(0);
	...
	function get_column(){
            ...
            $colModel['volume'] = array('volume',110,TRUE,'left',2);
	...
	function form($id=null){
		...
		$data['opt_metric']=GetOptAll('master_metric','-Volume-',array(),'name','code');
