...
class progress_trucking extends CI_Controller {
	
		var $utama ='progress_trucking';
		var $title ='Progress Trucking';
...
error_reporting(0);
	...
	function form($id=null){
		...
		$data['opt_coa']=GetOptAll('trucking_order','-All-',array(),'number');
		//End Global
