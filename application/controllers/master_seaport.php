...
class Master_seaport extends CI_Controller {
	
		var $utama ='master_seaport';
		var $title ='Master seaport';
...
error_reporting(0);
	...
	function get_column(){
		...
		$colModel['country'] = array('Country',110,TRUE,'left',2);
	...
	function get_record(){
            ...
            $valid_fields = array('id','code','name','country');
