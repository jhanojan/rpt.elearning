...
class Master_tingkat extends CI_Controller {
	
		var $utama ='master_tingkat';
		var $title ='Master Tingkat';
	...
	function listcol(){
            ...
            $colModel['title'] = array('Tingkat',110,TRUE,'left',2);
            $colModel['jenjang_'] = array('Nama Jenjang',110,TRUE,'left',2);
            return $colModel;
	}
	...
	function get_flexigrid()
        {
            ...
            $this->db->select("sv_a.*,sv_b.title jenjang_")->from("$this->utama sv_a");
            $this->db->join("master_jenjang sv_b","sv_a.jenjang=sv_b.id","left");
