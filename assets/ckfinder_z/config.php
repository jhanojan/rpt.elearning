...
$config['LicenseName'] = ''; 
$config['LicenseKey'] = 'PWQL-HPPD-PDR5-KXXP-9PF7-DZD6-V9FM';
...
$urlimage = "http://".$_SERVER['HTTP_HOST'];
$urlimage .= preg_replace('@/+$@','',dirname($_SERVER['SCRIPT_NAME'])).'/';
$urlimages = explode('assets/',$urlimage);
$baseUrl = $urlimages[0].'ck_uploads/';//'/rpt.elearning/ck_uploads/';
//$baseUrl = '/zaiko.id/ck_uploads/';
// $baseUrl = '/www/komunigrafik//ictp/ck_uploads'; // config on apache2
//$baseUrl = 'https://kamiahlinya.com/zaiko.id/ck_uploads/';
...
$baseDir = resolveUrl('/rpt.elearning/ck_uploads/');
//$baseDir = '/rpt.elearning/ck_uploads/';
//$baseDir = '/zaiko.id/ck_uploads/';
//$baseDir = './zaiko.id/ck_uploads/';
